    ...
    <div className="min-h-screen">
      <div className="bg-gradient-to-br from-brand-700 via-brand-600 to-brand-500 text-white">
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-10">
          <h1 className="text-3xl sm:text-4xl font-semibold">Manage Projects</h1>
          <p className="mt-2 text-white/80 max-w-2xl">Manage all Properties, assign contractors, and schedule work.</p>
          <div className="h-6" />
        </div>
      </div>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <Card title="Quick tips">
            <ul className="list-disc pl-5 text-sm text-gray-700 space-y-1">
              <li>Use statuses to track progress (Assigned → Started → Completed).</li>
              <li>Reassign contractors from the line items table.</li>
              <li>Export at any time to share a current view.</li>
            </ul>
          </Card>
          <Card title="What happens next?">
            <p className="text-sm text-gray-700">
              As you complete work, totals update automatically. Evidence can be added on completion.
            </p>
          </Card>
          <Card title="Links">
            <div className="flex flex-col gap-2 text-sm">
              <a className="underline text-brand-700" href="/app#jobs">Open projects</a>
              <a className="underline text-brand-700" href="/app#upload">Create project</a>
